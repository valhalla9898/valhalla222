...
```
GET /api/v1/qa/random?category=أمان
Response: {
  "id": 1,
  "question": "ما هو التشفير RSA؟",
  "category": "أمان",
  "difficulty": 3
}
```
...
POST /api/v1/qa/answer
{
  "user_id": "user123",
  "question_id": 1,
  "user_answer": "نظام تشفير غير متماثل",
  "time_taken": 45
}
Response: {
  "correct": true,
...
```
POST /api/v1/qa/quiz/start?category=برمجة&size=10
Response: {
...
- متفوق (Excellent) - 90%+
- ممتاز (Excellent) - 80%+
- جيد جداً (Very Good) - 70%+
- جيد (Good) - 60%+
- متوسط (Fair) - 50%+
- ضعيف (Poor) - 30%+
- ضعيف جداً (Very Poor) - <30%
